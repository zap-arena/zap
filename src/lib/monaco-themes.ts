...
export const EDITOR_THEME_OPTIONS = [
  { value: "vs-dark", label: "VS Dark", type: "dark" },
  { value: "light", label: "VS Light", type: "light" },
  { value: "hc-black", label: "High Contrast", type: "dark" },
  ...
  { value: "solarized-dark", label: "Solarized Dark", type: "dark" },
