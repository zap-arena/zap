...
export default function ThemeColorPicker({ size = 'sm' }: { size?: 'sm' | 'xs' }) {
  ...
  return (
    <Popover>
      ...
      <PopoverContent align="end" className="w-64 p-3">
        <p className="mb-2.5 text-xs font-semibold text-foreground">Select Color</p>
            ...
            return (
              ...
              >
                <span
                  ...
                  style={{ backgroundColor: `hsl(${a.dot.h} ${a.dot.s}% ${a.dot.l}%)` }}
                >
                  {selected && (
                    <Check size={12} strokeWidth={3} style={{ color: `hsl(${a.light.fg})` }} />
                  )}
                </span>
