...
export type BehaviorPattern =
  | 'optimal_from_start' | 'brute_then_optimized' | 'shortcut_then_rework' | 'struggling';
...
export interface StageAnalytics {
  ...
  complexity: { label: string; confidence: 'high' | 'low'; empirical: string | null; static: string } | null;
  expectedComplexity: string | null;
  submissions?: { id: string; status: Verdict; submittedAt: string; language: Language }[];
}
