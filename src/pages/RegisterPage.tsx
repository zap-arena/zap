...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex bg-background" style={{ background: 'var(--gradient-dark)' }}>
      {/* Left panel */}
      ...
      <div className="flex-1 flex items-center justify-center p-8 relative bg-background">
        ...
        <div className="w-full max-w-md animate-fade-in">
          ...
          <p className="text-muted-foreground text-sm mb-8">Join thousands of developers on ZAP</p>
