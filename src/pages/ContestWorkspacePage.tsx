...
export default function ContestWorkspacePage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      }>('/submissions', { problemId: selectedProblem.id, contestId, language, code });
                ...
                {selectedProblem ? (
                  <>
                    <div className="px-5 py-4 border-b border-border shrink-0">
                      <h2 className="font-bold text-base text-foreground mb-1">{selectedProblem.title}</h2>
                      <div className="flex items-center gap-3">
                        <DifficultyBadge difficulty={selectedProblem.difficulty} />
                        <span className="text-xs text-muted-foreground font-mono">
                          ⏱ {selectedProblem.timeLimit}s · 💾 {selectedProblem.memoryLimit}MB
                        </span>
                    ...
                    <div className="flex-1 overflow-y-auto px-5 py-4 space-y-5 text-sm text-foreground">
                      <div>
                        <h3 className="text-xs font-semibold text-primary uppercase tracking-wider mb-2">Description</h3>
                        <p className="text-muted-foreground leading-relaxed whitespace-pre-wrap">{selectedProblem.description}</p>
                      </div>
                      <div>
